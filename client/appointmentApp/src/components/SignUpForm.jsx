  ...
  return (
    <div className="sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl mx-auto" >
      <div className="flex bg-slate-800 p-1 gap-x-1 mt-6 rounded-full max-w-max ">
        ...
        <button className={`${accountType=== "employee"? "bg-slate-900 text-slate-300":"bg-transparent text-slate-200"} py-2 px-5 rounded-full transition-all duration-200`} onClick={()=>setAccountType("employee")}>employee</button>
      </div>
