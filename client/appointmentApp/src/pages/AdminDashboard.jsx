...
const AdminDashboard = () => {
  ...
  async function submitHandler()  {
    ...
    const newStore = {
      ...
      openTime: openTime,
      closeTime: closeTime,
      employees: parseInt(numEmployees), 
    ...
    try {
      ...
      if (response.ok) {
        ...
        // If request is successful, update local state
        const data = await response.json();
  ...
  async function deleteHandler(storeId){
    try {
  ...
  <div className="flex items-center justify-center bg-white px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
    <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
      ...
      <form action="#" method="POST" className="mt-8">
        ...
        <div>
            <label htmlhtmlfor="" className="text-base font-medium text-gray-900">
              {" "}
              Store Name{" "}
            </label>
            <div className="mt-2">
            ...
            <thead className="bg-gray-50">
              <tr>
                ...
                <th scope="col" className="relative px-4 py-3.5">
                  <span className="sr-only"><HiArchiveBoxXMark/></span>
                </th>
              </tr>
            </thead>
              ...
              {store.map((stores,index) => (
                <tr key={index}>
                  ...
                  <td className="whitespace-nowrap px-4 py-4 text-right text-sm font-medium">
                    <button onClick={()=>deleteHandler(stores._id)} className="text-gray-700">
                    <HiArchiveBoxXMark/>
                    </button>
                  </td>
                </tr>
